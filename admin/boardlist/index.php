                  ...
                  <table class="table table-borderless datatable">
                    <thead>
                      <tr>
                        ...
                        <th scope="col" style="white-space: nowrap;">TRACKING ID</th>
                    ...
                    <tbody>
                      ...
                      <?php
                            $query = mysqli_query($connection,"SELECT * FROM `Bills`");
                            ...
                            if (mysqli_num_rows($query) > 0){
                              ...
                              while($details = mysqli_fetch_assoc($query)){ $count++?>
                                  ...
                                  <tr>
                                    ...
                                    <td><a href="?id=<?php echo $details['id'];?>"><span class="badge" style="background-color:red;padding:7px;">Delete</span></a></td>
...
<?php
        ...
        if (isset($_GET['id'])){
            ...
            $del_id = $_GET['id'];
            $query = mysqli_query($connection,"DELETE FROM `bills` WHERE `id`='$del_id'");
