                              ...
                              while($details = mysqli_fetch_assoc($query)){ $count++?>
                                ...
                                <tr>
                                    ...
                                    <?php 
                                        ...
                                        if ($details['status'] == 'previouse'){ ?>


                                            <td><a href="?track=<?php echo $details['track'];?>&mode=current&id=<?php echo $details['id'];?>"><span class="badge" style="background-color:blue;padding:7px;">current</span></a></td>
                                      ...
                                      <?php  }
                                        ...
                                        if ($details['status'] == 'current'){ ?>
                                                    ...
                                                    <td><a href="?track=<?php echo $details['track'];?>&mode=previouse&id=<?php echo $details['id'];?>"><span class="badge" style="background-color:blue;padding:7px;">previouse</span></a></td>
