...
<?php  }
        ...
        setTimeout(()=>{window.open('$url', '_self')},0);</script>";
    }
} else {
        ...
        <div id="display">
            ...
            <section>
                ...
                while ($message = mysqli_fetch_assoc($sql)) { ?>
                    <main>
                        <div class="container">
                            <h2 class="table-title">Overview Information</h2>
                            <table class="table">
                                <tbody>
                                    <tr>
                                    ...
                                    <tr>
                                        <td data-label="full-name">Description</td>
                                        <td data-label="full-name"> <?php echo $message['description'];  ?></td>
                                    </tr>
                                    <tr>
                    ...
                    <div class="container">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                $track = $_GET['track'];
                                $sql = mysqli_query($connection, "SELECT * FROM `issues` WHERE `track`='$track'");
